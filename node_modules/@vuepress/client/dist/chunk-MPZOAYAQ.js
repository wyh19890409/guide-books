...
// src/router/resolveRoutePath.ts
var resolveRoutePath = (path, currentPath) => {
...
var RouteLink = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const path = computed(
      () => props.to.startsWith("#") || props.to.startsWith("?") ? props.to : `${__VUEPRESS_BASE__}${resolveRoutePath(props.to, route.path).substring(1)}`
    );
    return () => h(
      "a",
      {
